...
function! NeedsVundleInstalled()
    echohl Type 'NeedsVundleInstalled called')
    let s:hv_lsresult=system('ls /root/.vim/Vundle.vim')
    return match(s:hv_lsresult, 'cannot access') > 0
endfunction

function! InstallVundle()
   silent !git clone https://github.com/VundleVim/Vundle.vim.git /root/.vim/Vundle.vim
...
if NeedsVundleInstalled()
    echohl String "Vundle Install Required"
    call InstallVundle()
else
    set rtp+=/root/.vim/Vundle.vim
    source vundle.vim
