...
imenu MenuSelector.Insert :popup Insert<CR>


nmenu EditConfig.Colors             :e  /var/git/ashe/vim/config/ac.colors.vim<CR>
nmenu EditConfig.Core               :e  /var/git/ashe/vim/config/ac.core.vim<CR>
nmenu EditConfig.Ftplugins.Make     :e  /var/git/ashe/vim/config/ac.ftplugins.make.vim<CR>
nmenu EditConfig.Keys               :e  /var/git/ashe/vim/config/ac.keys.vim<CR>
nmenu EditConfig.Menus              :e  /var/git/ashe/vim/config/ac.menus.vim<CR>
nmenu EditConfig.Plugins            :e  /var/git/ashe/vim/config/ac.plugins.vim<CR>
